...
func (t *TbUnSubscribe) TableName() string {
...
// GetTbUnSubscribeById retrieves TbUnSubscribe by Id. Returns error if
// Id doesn't exist
func GetTbUnSubscribeById(id int64) (v *TbUnSubscribe, err error) {
	o := orm.NewOrm()
	v = &TbUnSubscribe{Id: id}
...
// GetAllTbUnSubscribe retrieves all TbUnSubscribe matches certain condition. Returns empty list if
// no records exist
func GetAllTbUnSubscribe(query map[string]string, fields []string, sortby []string, order []string,
	offset int64, limit int64) (ml []interface{}, err error) {
	o := orm.NewOrm()
	qs := o.QueryTable(new(TbUnSubscribe))
	// query k=v
	for k, v := range query {
...
// UpdateTbUnSubscribe updates TbUnSubscribe by Id and returns error if
// the record to be updated doesn't exist
func UpdateTbUnSubscribeById(m *TbUnSubscribe) (err error) {
	o := orm.NewOrm()
	v := TbUnSubscribe{Id: m.Id}
...
// DeleteTbUnSubscribe deletes TbUnSubscribe by Id and returns error if
// the record to be deleted doesn't exist
func DeleteTbUnSubscribe(id int64) (err error) {
	o := orm.NewOrm()
	v := TbUnSubscribe{Id: id}
	// ascertain id exists in the database
	if err = o.Read(&v); err == nil {
		var num int64
		if num, err = o.Delete(&TbUnSubscribe{Id: id}); err == nil {
