...
// MoveOwner is a paid mutator transaction binding the contract method 0x8ba4cedf.
//
// Solidity: function moveOwner(address _newOwner) returns()
func (_Token *TokenTransactor) MoveOwner(opts *bind.TransactOpts, _newOwner common.Address) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "moveOwner", _newOwner)
}

// MoveOwner is a paid mutator transaction binding the contract method 0x8ba4cedf.
//
// Solidity: function moveOwner(address _newOwner) returns()
func (_Token *TokenSession) MoveOwner(_newOwner common.Address) (*types.Transaction, error) {
	return _Token.Contract.MoveOwner(&_Token.TransactOpts, _newOwner)
}

// MoveOwner is a paid mutator transaction binding the contract method 0x8ba4cedf.
//
// Solidity: function moveOwner(address _newOwner) returns()
func (_Token *TokenTransactorSession) MoveOwner(_newOwner common.Address) (*types.Transaction, error) {
	return _Token.Contract.MoveOwner(&_Token.TransactOpts, _newOwner)
}
